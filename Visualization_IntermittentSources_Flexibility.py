...
suptitle = (r"$\bf Flexibility \: By \: Intermittent \: Sources$"+"\nSimulation of 72h")
...
legendAgg = ("Potential Generation", "Realized Generation","Solar PV 25MWp", "Upward Flexibility 10MW","Downward Flexibility")
...
legendDemand = ("Realized Consumption","Downward Flexibility", "Upward Flexibility", "Shedding Limit 50MW")
...
for j in range(4):
    ...
    axes[int(j/2),j%2].legend(("Potential Generation","Realized Generation","Upward Flexibility 10MW ","Downward Flexibility"))
